...
enum class Kingdom : uint8_t { None = 0,
	                           North = 1,
	                           West = 2,
	                           South = 3,
	                           East = 4 };
...
public:
	...
	void setGovernor(bool v) {
		isGovernor_ = v;
	}
	void setKingdom(uint8_t k) {
		kingdom_ = static_cast<Kingdom>(k);
	}
...
private:
	...
	bool isPresident_ = false;
	bool isGovernor_ = false;
	Kingdom kingdom_ = Kingdom::None;
